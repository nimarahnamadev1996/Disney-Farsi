...
const CarsouelBanner = ({movies}: {movies: Movie[]}) => {
                ...
                movies.map((movie) => (
                    ...
                    className="flex-full min-w-0 relative">
                        <Image
                         ...
                         <div 
                         className="hidden lg:inline absolute mt-0 top-0 pt-40 xl:pt-52 right-0 lg:mt-40 bg-transparent z-20 h-full w-full bg-gradient-to-r from-gray-900/90 via-transparent p-10 space-y-5 text-white">
                           <h2 className="text-5xl font-bold line-clamp-3">
                             {movie.title}
                            </h2>
